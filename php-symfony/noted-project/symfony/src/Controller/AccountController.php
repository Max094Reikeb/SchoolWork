...
class AccountController extends AbstractController
{
    ...
    #[Route('/new/{id}', name: 'app_account_new_id', methods: ['GET', 'POST'])]
    public function newForPerson(Request $request, EntityManagerInterface $entityManager, Person $person): Response
    {
        $account = new Account();
